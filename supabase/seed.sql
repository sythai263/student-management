...
-- 3. Classes
-- -------------------------------------------------------------
insert into public.classes (id, "classCode", name, "schoolYear", "teacherId") values
  ('aaaaaaaa-0000-0000-0000-000000000001', '10A1', '10A1', '2025-2026', '11111111-1111-1111-1111-111111111111'),
  ('aaaaaaaa-0000-0000-0000-000000000002', '11B2', '11B2', '2025-2026', '11111111-1111-1111-1111-111111111111');

-- -------------------------------------------------------------
-- 4. Students — 10A1 (8 HS), 11B2 (5 HS)
-- -------------------------------------------------------------
insert into public.students ("studentCode", "lastName", "firstName", "dateOfBirth", "classId") values
  ('10A101', 'Nguyễn Văn', 'An',   '2010-03-15', 'aaaaaaaa-0000-0000-0000-000000000001'),
  ('10A102', 'Trần Thị',   'Bình', '2010-05-20', 'aaaaaaaa-0000-0000-0000-000000000001'),
  ('10A103', 'Lê Hoàng',   'Cường','2010-01-08', 'aaaaaaaa-0000-0000-0000-000000000001'),
  ('10A104', 'Phạm Minh',  'Dũng', '2010-07-22', 'aaaaaaaa-0000-0000-0000-000000000001'),
  ('10A105', 'Hoàng Thu',  'Hà',   '2010-11-30', 'aaaaaaaa-0000-0000-0000-000000000001'),
  ('10A106', 'Vũ Đức',     'Khang','2010-02-14', 'aaaaaaaa-0000-0000-0000-000000000001'),
  ('10A107', 'Đặng Ngọc',  'Linh', '2010-09-05', 'aaaaaaaa-0000-0000-0000-000000000001'),
  ('10A108', 'Bùi Quốc',   'Nam',  '2010-04-18', 'aaaaaaaa-0000-0000-0000-000000000001'),
  ('11B201', 'Ngô Thanh',  'Mai',  '2009-06-10', 'aaaaaaaa-0000-0000-0000-000000000002'),
  ('11B202', 'Đỗ Hữu',     'Phúc', '2009-08-25', 'aaaaaaaa-0000-0000-0000-000000000002'),
  ('11B203', 'Trịnh Kim',  'Ngân', '2009-12-01', 'aaaaaaaa-0000-0000-0000-000000000002'),
  ('11B204', 'Lý Gia',     'Bảo',  '2009-03-17', 'aaaaaaaa-0000-0000-0000-000000000002'),
  ('11B205', 'Phan Anh',   'Tuấn', '2009-10-09', 'aaaaaaaa-0000-0000-0000-000000000002');
